...
class HorizontalCarouselRecyclerView(
    ...
    private val activeColor by lazy { ContextCompat.getColor(context, android.R.color.white) }
    private val inactiveColor by lazy { ContextCompat.getColor(context, android.R.color.darker_gray) }
